...
void Vision_Tx_Data(MOTOR_Typedef *motor)
{
    ...
    VisionTxData.PitchAngle = motor->M6020_lk[PITCH].DATA.Angle_Infinite;
    VisionTxData.YawAngle = motor->M6020_lk[YAW].DATA.Angle_Infinite;
    VisionTxData.PitchOmega = motor->M6020_lk[PITCH].DATA.Speed_now / 6.0f;
    VisionTxData.YawOmega = motor->M6020_lk[YAW].DATA.Speed_now / 6.0f;
